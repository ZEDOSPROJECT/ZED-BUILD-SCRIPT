...
if [[ $EUID -ne 0 ]]; then
	...
	echo "Cleaning . . ."
	apt purge ubuntu-mate-welcome gnome-keyring firefox* libreoffice* blueman -y &> /dev/null
	apt autoremove -y
	apt autoclean -y
